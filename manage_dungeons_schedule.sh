...
test_run() {
    ...
    if [[ "$confirm" =~ ^[Yy]$ ]]; then
        print_info "正在启动副本任务..."
        /Users/weiwang/Projects/miniwow/cron_run_all_dungeons.sh
        print_success "任务已完成"
        sleep 2
        show_logs
    else
...
<dict>
    ...
    <key>Program</key>
    <string>/Users/weiwang/Projects/miniwow/test_wake.sh</string>
    <key>StartCalendarInterval</key>
    <dict>
        <key>Hour</key>
